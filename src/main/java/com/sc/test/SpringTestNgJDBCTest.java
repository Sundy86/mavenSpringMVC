...
public class SpringTestNgJDBCTest extends AbstractTestNGSpringContextTests {
    ...
    public void delete(){
        String sql = "delete from myuser where email=?";
        jdbcTemplate.update(sql,"scaa@160.com");
    }
